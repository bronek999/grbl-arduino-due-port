...
#define ACCELERATION_TICKS_PER_SECOND 300 
...
#define xADAPTIVE_MULTI_AXIS_STEP_SMOOTHING  // Default enabled. Comment to disable.
...
#define xVARIABLE_SPINDLE // Default enabled. Comment to disable.
